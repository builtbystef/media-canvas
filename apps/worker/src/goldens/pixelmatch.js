// pixelmatch 7.2.0 (ISC, Mapbox / Volodymyr Agafonkin). Vendored because this
// session cannot reach the npm registry; the algorithm is the golden contract
// (issue 6bqdxe) and must be this library, not a rewrite.
