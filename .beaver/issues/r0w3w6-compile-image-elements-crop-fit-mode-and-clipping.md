...
- [ ] `clip: 'ellipse'` clips the image to the ellipse inscribed in its frame; `clip: {path}` clips it to that path; `clip: 'none'` clips it to the frame, honouring the corner radius.
