...
- [ ] A render that cannot complete fails with an error naming the cause — markup that will not load, or an image the page cannot fetch — instead of returning a partial or placeholder image.
